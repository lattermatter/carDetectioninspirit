...
# base64_font_path = "base64.txt"

# # Read the base64 string from the file
# with open(base64_font_path, "r") as f:
#     font_base64 = f.read()
...
# Load the font
# fontalter = ImageFont.truetype("arial", 20)

# Load the font

def draw_boxes(image_, boxes, labels, font_path):
    image = image_.copy()
    ...
    for i, box in reversed(list(enumerate(boxes))):
        ...
        for i in range(thickness):
            ...
            #     print(label, (left, top), (right, bottom))
            # ^^^^^^^
            # Old code that was not working properly. bounding boxes drawn in the wrong location
            ...
            try:
                ...
                print
            # new code fails at one case out of all boxes
...
def detect_image(image_pil, obj_thresh = 0.4, nms_thresh = 0.45, darknet=darknet, net_h=416, net_w=416, anchors=anchors, labels=labels):
  ...
  return draw_boxes(image_pil, new, labels, "arial.ttf")
